...
__kernel void cg(__global double * restrict x_1, 
                 ...
                 __global const double * restrict w_1,
                 __global const double * restrict w_2,
                 __global const double * restrict w_3,
                 __global const double * restrict w_4,
...
{  
    ...
    for(int i = 0; i < nb; i++){
        ...
        for(int j =0; j < blk_len; j++){
            ...
            double cur = rtr_copies3[M2-1] + wn[blk_data.bank[j]][blk_data.idx[j]];
            #pragma unroll
